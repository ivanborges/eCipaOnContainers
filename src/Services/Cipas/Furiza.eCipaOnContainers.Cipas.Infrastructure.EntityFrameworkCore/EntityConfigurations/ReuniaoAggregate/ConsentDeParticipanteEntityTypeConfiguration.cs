...
{
    internal class ConsentDeParticipanteEntityTypeConfiguration : IEntityTypeConfiguration<ConsentDeParticipante>
    {
        public void Configure(EntityTypeBuilder<ConsentDeParticipante> builder)
        {
            builder.ToTable("ConsentsDeParticipantes");
            ...
            builder.Property<Guid>("ParticipanteId").IsRequired();
        }
    }
}